...
export default function MobileHeader() {
  ...
  return (
    <header className="md:hidden sticky top-0 left-0 w-full bg-white border-b border-gray-300 flex items-center justify-between py-2 px-4 ">
      <h1 className="text-[28px] leading-none font-extrabold">{label}</h1>
      <UserMenuMobile />
    </header>
  );
}
